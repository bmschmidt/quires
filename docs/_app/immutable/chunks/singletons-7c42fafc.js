import { B as d, s as w } from './index-c1110d94.js';
import { a as E } from './paths-b4419565.js';
const c = [];
function p(e, t = d) {
	let n;
	const o = new Set();
...
function v() {
	...
	async function o() {
		clearTimeout(n);
		const s = await fetch(`${E}/_app/version.json`, {
			headers: { pragma: 'no-cache', 'cache-control': 'no-cache' }
		});
		if (s.ok) {
			const l = (await s.json()).version !== h;
...
const N = { url: g({}), page: g({}), navigating: p(null), updated: v() };
export {
	A as I,
	b as P,
	y as S,
