			...
			if (tso_info.ffiRetErr) {
				...
				const stackobj = Number(this.memory.i64Load(tso + rtsConstants.offset_StgTSO_stackobj)),
					...
					exception_closure = this.exports.rts_apply(
						this.symbolTable.addressOf('base_AsteriusziTypesziJSException_mkJSException_closure'),
						this.exports.rts_mkJSVal(this.components.jsvalManager.newJSValzh(tso_info.ffiRetErr))
					);
