<script lang="ts">
  ...
  import Copy32 from "carbon-icons-svelte/lib/Copy32";
  import Run32 from "carbon-icons-svelte/lib/Run32";
...
<div style="display:flex;">
  ...
  {/if}
  <pre id="{id}" class="{classes.join(" ")}" {...attrs}>
    {@html html}
  </pre>
</div>
