...
<div style="margin-left:15%;margin-right:15%;">
   ...
   <a href="https://github.com/bmschmidt/pandoc-svelte-components/blob/main/src/routes/demo/_ObservedParagraph.svelte">here</a> on the Markdown defined
   <a href="https://github.com/bmschmidt/pandoc-svelte-components/blob/main/src/demo_data/history.md">here</a>
   The IntersectionObserver is created externally to the svelte components, <a href="https://github.com/bmschmidt/pandoc-svelte-components/blob/main/src/routes/demo/observer.svelte">here.</a>
